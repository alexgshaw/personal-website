...
const LOGOS = [
  ...
  {
    src: "/logos/elevation.jpeg",
    alt: "Elevation Capital",
  },
  {
    src: "/logos/max-planck.jpeg",
    ...
    <div className="space-y-16">
      <div className="w-full max-w-2xl space-y-6">
        ...
        <div className="flex h-5 space-x-6">
          <a
            href="https://github.com/alexgshaw"
            target="_blank"
            className="flex fill-zinc-500 transition duration-200 hover:fill-zinc-600"
          >
          ...
          <a
            href="https://www.linkedin.com/in/alexgshaw/"
            target="_blank"
            className="flex fill-zinc-500 transition duration-200 hover:fill-zinc-600"
          >
          ...
          <a
            href="https://twitter.com/alexgshaw"
            target="_blank"
            className="flex fill-zinc-500 transition duration-200 hover:fill-zinc-600"
          >
          ...
          <a
            href="https://www.instagram.com/alexshaw8/"
            target="_blank"
            className="flex fill-zinc-500 transition duration-200 hover:fill-zinc-600"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
      ...
      <div className="flex flex-col space-y-16">
        ...
        />
        <HoverCard as={Link} href="/work" className="flex flex-col space-y-6">
          <p className="z-10 font-medium">Work Experience</p>
          <div className="flex flex-wrap">
            {LOGOS.map(({ src, alt }) => (
              <ImageCircle
                className="z-10 mb-6 mr-6"
                key={alt}
                src={src}
                alt={alt}
              />
